...
{
 UInt32 time_usec; ///< Timestamp (since UNIX epoch or microseconds since system boot)
...
static inline void mavlink_msg_servo_output_raw_send(mavlink_channel_t chan, UInt32 time_usec, byte port, UInt16 servo1_raw, UInt16 servo2_raw, UInt16 servo3_raw, UInt16 servo4_raw, UInt16 servo5_raw, UInt16 servo6_raw, UInt16 servo7_raw, UInt16 servo8_raw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[21];
	_mav_put_UInt32(buf, 0, time_usec);
 ...
 */
static inline UInt32 mavlink_msg_servo_output_raw_get_time_usec(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_servo_output_raw_get_port(const mavlink_message_t* msg)
{
