...
{
 Int16 start_index; ///< Start index, 0 by default and smaller / equal to the largest index of the current onboard list.
 Int16 end_index; ///< End index, equal or greater than start index.
...
static inline uint16_t mavlink_msg_mission_write_partial_list_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       byte target_system, byte target_component, Int16 start_index, Int16 end_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[6];
	_mav_put_Int16(buf, 0, start_index);
	_mav_put_Int16(buf, 2, end_index);
...
static inline void mavlink_msg_mission_write_partial_list_send(mavlink_channel_t chan, byte target_system, byte target_component, Int16 start_index, Int16 end_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[6];
	_mav_put_Int16(buf, 0, start_index);
 ...
 * @return System ID
 */
static inline byte mavlink_msg_mission_write_partial_list_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static inline byte mavlink_msg_mission_write_partial_list_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static inline Int16 mavlink_msg_mission_write_partial_list_get_start_index(const mavlink_message_t* msg)
{
 ...
 */
static inline Int16 mavlink_msg_mission_write_partial_list_get_end_index(const mavlink_message_t* msg)
{
