...
static inline void mavlink_msg_vision_position_estimate_send(mavlink_channel_t chan, UInt64 usec, Single x, Single y, Single z, Single roll, Single pitch, Single yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[32];
	_mav_put_UInt64(buf, 0, usec);
 ...
 */
static inline UInt64 mavlink_msg_vision_position_estimate_get_usec(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_vision_position_estimate_get_x(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_vision_position_estimate_get_y(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_vision_position_estimate_get_z(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_vision_position_estimate_get_roll(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_vision_position_estimate_get_pitch(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_vision_position_estimate_get_yaw(const mavlink_message_t* msg)
{
