...
static inline void mavlink_msg_manual_control_send(mavlink_channel_t chan, byte target, Single roll, Single pitch, Single yaw, Single thrust, byte roll_manual, byte pitch_manual, byte yaw_manual, byte thrust_manual)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[21];
	_mav_put_Single(buf, 0, roll);
 ...
 */
static inline byte mavlink_msg_manual_control_get_target(const mavlink_message_t* msg)
{
 ...
 * @return roll
 */
static inline Single mavlink_msg_manual_control_get_roll(const mavlink_message_t* msg)
{
 ...
 * @return pitch
 */
static inline Single mavlink_msg_manual_control_get_pitch(const mavlink_message_t* msg)
{
 ...
 * @return yaw
 */
static inline Single mavlink_msg_manual_control_get_yaw(const mavlink_message_t* msg)
{
 ...
 * @return thrust
 */
static inline Single mavlink_msg_manual_control_get_thrust(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_manual_control_get_roll_manual(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_manual_control_get_pitch_manual(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_manual_control_get_yaw_manual(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_manual_control_get_thrust_manual(const mavlink_message_t* msg)
{
