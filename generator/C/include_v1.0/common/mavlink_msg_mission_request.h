...
static inline void mavlink_msg_mission_request_send(mavlink_channel_t chan, byte target_system, byte target_component, UInt16 seq)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[4];
	_mav_put_UInt16(buf, 0, seq);
 ...
 * @return System ID
 */
static inline byte mavlink_msg_mission_request_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static inline byte mavlink_msg_mission_request_get_target_component(const mavlink_message_t* msg)
{
 ...
 * @return Sequence
 */
static inline UInt16 mavlink_msg_mission_request_get_seq(const mavlink_message_t* msg)
{
