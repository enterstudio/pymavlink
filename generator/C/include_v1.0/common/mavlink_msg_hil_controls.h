...
typedef struct __mavlink_hil_controls_t
{
 ...
 Single roll_ailerons; ///< Control output -1 .. 1
 Single pitch_elevator; ///< Control output -1 .. 1
 Single yaw_rudder; ///< Control output -1 .. 1
 Single throttle; ///< Throttle 0 .. 1
 Single aux1; ///< Aux 1, -1 .. 1
 Single aux2; ///< Aux 2, -1 .. 1
 Single aux3; ///< Aux 3, -1 .. 1
 Single aux4; ///< Aux 4, -1 .. 1
 byte mode; ///< System mode (MAV_MODE)
 byte nav_mode; ///< Navigation mode (MAV_NAV_MODE)
...
static inline void mavlink_msg_hil_controls_send(mavlink_channel_t chan, UInt64 time_usec, Single roll_ailerons, Single pitch_elevator, Single yaw_rudder, Single throttle, Single aux1, Single aux2, Single aux3, Single aux4, byte mode, byte nav_mode)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[42];
	_mav_put_UInt64(buf, 0, time_usec);
 ...
 */
static inline UInt64 mavlink_msg_hil_controls_get_time_usec(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_hil_controls_get_roll_ailerons(const mavlink_message_t* msg)
{
 ...
 * @return Control output -1 .. 1
 */
static inline Single mavlink_msg_hil_controls_get_pitch_elevator(const mavlink_message_t* msg)
{
 ...
 * @return Control output -1 .. 1
 */
static inline Single mavlink_msg_hil_controls_get_yaw_rudder(const mavlink_message_t* msg)
{
 ...
 * @return Throttle 0 .. 1
 */
static inline Single mavlink_msg_hil_controls_get_throttle(const mavlink_message_t* msg)
{
 ...
 * @return Aux 1, -1 .. 1
 */
static inline Single mavlink_msg_hil_controls_get_aux1(const mavlink_message_t* msg)
{
 ...
 * @return Aux 2, -1 .. 1
 */
static inline Single mavlink_msg_hil_controls_get_aux2(const mavlink_message_t* msg)
{
 ...
 * @return Aux 3, -1 .. 1
 */
static inline Single mavlink_msg_hil_controls_get_aux3(const mavlink_message_t* msg)
{
 ...
 * @return Aux 4, -1 .. 1
 */
static inline Single mavlink_msg_hil_controls_get_aux4(const mavlink_message_t* msg)
{
	return _MAV_RETURN_Single(msg,  36);
}
 ...
 */
static inline byte mavlink_msg_hil_controls_get_mode(const mavlink_message_t* msg)
{
	return _MAV_RETURN_byte(msg,  40);
}
 ...
 */
static inline byte mavlink_msg_hil_controls_get_nav_mode(const mavlink_message_t* msg)
{
	return _MAV_RETURN_byte(msg,  41);
}
