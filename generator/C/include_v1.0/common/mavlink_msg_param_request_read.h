...
{
 Int16 param_index; ///< Parameter index. Send -1 to use the param ID field as identifier
...
static inline uint16_t mavlink_msg_param_request_read_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       byte target_system, byte target_component, const string *param_id, Int16 param_index)
{
...
static inline void mavlink_msg_param_request_read_send(mavlink_channel_t chan, byte target_system, byte target_component, const string *param_id, Int16 param_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[20];
	_mav_put_Int16(buf, 0, param_index);
 ...
 */
static inline uint16_t mavlink_msg_param_request_read_get_param_id(const mavlink_message_t* msg, string *param_id)
{
	return _MAV_RETURN_string_array(msg, param_id, 16,  4);
}
 ...
 */
static inline Int16 mavlink_msg_param_request_read_get_param_index(const mavlink_message_t* msg)
{
