...
typedef struct __mavlink_raw_imu_t
{
 ...
 Int16 xacc; ///< X acceleration (raw)
 Int16 yacc; ///< Y acceleration (raw)
 Int16 zacc; ///< Z acceleration (raw)
 Int16 xgyro; ///< Angular speed around X axis (raw)
 Int16 ygyro; ///< Angular speed around Y axis (raw)
 Int16 zgyro; ///< Angular speed around Z axis (raw)
 Int16 xmag; ///< X Magnetic field (raw)
 Int16 ymag; ///< Y Magnetic field (raw)
 Int16 zmag; ///< Z Magnetic field (raw)
} mavlink_raw_imu_t;
...
static inline void mavlink_msg_raw_imu_send(mavlink_channel_t chan, UInt64 time_usec, Int16 xacc, Int16 yacc, Int16 zacc, Int16 xgyro, Int16 ygyro, Int16 zgyro, Int16 xmag, Int16 ymag, Int16 zmag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[26];
	_mav_put_UInt64(buf, 0, time_usec);
 ...
 */
static inline UInt64 mavlink_msg_raw_imu_get_time_usec(const mavlink_message_t* msg)
{
