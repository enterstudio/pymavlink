...
static inline void mavlink_msg_global_position_setpoint_int_send(mavlink_channel_t chan, byte coordinate_frame, Int32 latitude, Int32 longitude, Int32 altitude, Int16 yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[15];
	_mav_put_Int32(buf, 0, latitude);
 ...
 */
static inline byte mavlink_msg_global_position_setpoint_int_get_coordinate_frame(const mavlink_message_t* msg)
{
 ...
 */
static inline Int32 mavlink_msg_global_position_setpoint_int_get_latitude(const mavlink_message_t* msg)
{
 ...
 */
static inline Int32 mavlink_msg_global_position_setpoint_int_get_longitude(const mavlink_message_t* msg)
{
 ...
 */
static inline Int32 mavlink_msg_global_position_setpoint_int_get_altitude(const mavlink_message_t* msg)
{
 ...
 */
static inline Int16 mavlink_msg_global_position_setpoint_int_get_yaw(const mavlink_message_t* msg)
{
