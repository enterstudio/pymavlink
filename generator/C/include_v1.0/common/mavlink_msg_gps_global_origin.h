...
static inline void mavlink_msg_gps_global_origin_send(mavlink_channel_t chan, Int32 latitude, Int32 longitude, Int32 altitude)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_Int32(buf, 0, latitude);
 ...
 */
static inline Int32 mavlink_msg_gps_global_origin_get_latitude(const mavlink_message_t* msg)
{
 ...
 */
static inline Int32 mavlink_msg_gps_global_origin_get_longitude(const mavlink_message_t* msg)
{
 ...
 */
static inline Int32 mavlink_msg_gps_global_origin_get_altitude(const mavlink_message_t* msg)
{
