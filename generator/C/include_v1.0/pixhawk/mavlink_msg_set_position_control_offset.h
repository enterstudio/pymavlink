...
static inline void mavlink_msg_set_position_control_offset_send(mavlink_channel_t chan, byte target_system, byte target_component, Single x, Single y, Single z, Single yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[18];
	_mav_put_Single(buf, 0, x);
 ...
 * @return System ID
 */
static inline byte mavlink_msg_set_position_control_offset_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static inline byte mavlink_msg_set_position_control_offset_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_set_position_control_offset_get_x(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_set_position_control_offset_get_y(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_set_position_control_offset_get_z(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_set_position_control_offset_get_yaw(const mavlink_message_t* msg)
{
