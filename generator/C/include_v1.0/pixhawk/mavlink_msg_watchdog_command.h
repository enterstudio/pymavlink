...
typedef struct __mavlink_watchdog_command_t
{
 ...
 byte target_system_id; ///< Target system ID
...
static inline void mavlink_msg_watchdog_command_send(mavlink_channel_t chan, byte target_system_id, UInt16 watchdog_id, UInt16 process_id, byte command_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[6];
	_mav_put_UInt16(buf, 0, watchdog_id);
 ...
 */
static inline byte mavlink_msg_watchdog_command_get_target_system_id(const mavlink_message_t* msg)
{
 ...
 * @return Watchdog ID
 */
static inline UInt16 mavlink_msg_watchdog_command_get_watchdog_id(const mavlink_message_t* msg)
{
 ...
 * @return Process ID
 */
static inline UInt16 mavlink_msg_watchdog_command_get_process_id(const mavlink_message_t* msg)
{
 ...
 * @return Command ID
 */
static inline byte mavlink_msg_watchdog_command_get_command_id(const mavlink_message_t* msg)
{
