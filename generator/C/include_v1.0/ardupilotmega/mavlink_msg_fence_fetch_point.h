...
static inline uint16_t mavlink_msg_fence_fetch_point_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       byte target_system, byte target_component, byte idx)
{
...
static inline void mavlink_msg_fence_fetch_point_send(mavlink_channel_t chan, byte target_system, byte target_component, byte idx)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[3];
	_mav_put_byte(buf, 0, target_system);
 ...
 * @return System ID
 */
static inline byte mavlink_msg_fence_fetch_point_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static inline byte mavlink_msg_fence_fetch_point_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_fence_fetch_point_get_idx(const mavlink_message_t* msg)
{
