...
{
 Single lat; ///< Latitude of point
 Single lng; ///< Longitude of point
 byte target_system; ///< System ID
 byte target_component; ///< Component ID
 byte idx; ///< point index (first point is 1, 0 is for return point)
 byte count; ///< total number of points (for sanity checking)
...
static inline uint16_t mavlink_msg_fence_point_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       byte target_system, byte target_component, byte idx, byte count, Single lat, Single lng)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_Single(buf, 0, lat);
	_mav_put_Single(buf, 4, lng);
	_mav_put_byte(buf, 8, target_system);
	_mav_put_byte(buf, 9, target_component);
	_mav_put_byte(buf, 10, idx);
	_mav_put_byte(buf, 11, count);
...
static inline void mavlink_msg_fence_point_send(mavlink_channel_t chan, byte target_system, byte target_component, byte idx, byte count, Single lat, Single lng)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_Single(buf, 0, lat);
 ...
 * @return System ID
 */
static inline byte mavlink_msg_fence_point_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static inline byte mavlink_msg_fence_point_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_fence_point_get_idx(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_fence_point_get_count(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_fence_point_get_lat(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_fence_point_get_lng(const mavlink_message_t* msg)
{
