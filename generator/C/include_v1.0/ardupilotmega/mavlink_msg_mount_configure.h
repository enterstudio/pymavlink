...
typedef struct __mavlink_mount_configure_t
{
 ...
 byte mount_mode; ///< mount operating mode (see MAV_MOUNT_MODE enum)
 byte stab_roll; ///< (1 = yes, 0 = no)
 byte stab_pitch; ///< (1 = yes, 0 = no)
 byte stab_yaw; ///< (1 = yes, 0 = no)
...
static inline uint16_t mavlink_msg_mount_configure_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       byte target_system, byte target_component, byte mount_mode, byte stab_roll, byte stab_pitch, byte stab_yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[6];
	_mav_put_byte(buf, 0, target_system);
	_mav_put_byte(buf, 1, target_component);
	_mav_put_byte(buf, 2, mount_mode);
	_mav_put_byte(buf, 3, stab_roll);
	_mav_put_byte(buf, 4, stab_pitch);
	_mav_put_byte(buf, 5, stab_yaw);
...
static inline void mavlink_msg_mount_configure_send(mavlink_channel_t chan, byte target_system, byte target_component, byte mount_mode, byte stab_roll, byte stab_pitch, byte stab_yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[6];
	_mav_put_byte(buf, 0, target_system);
 ...
 * @return System ID
 */
static inline byte mavlink_msg_mount_configure_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static inline byte mavlink_msg_mount_configure_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_mount_configure_get_mount_mode(const mavlink_message_t* msg)
{
 ...
 * @return (1 = yes, 0 = no)
 */
static inline byte mavlink_msg_mount_configure_get_stab_roll(const mavlink_message_t* msg)
{
 ...
 * @return (1 = yes, 0 = no)
 */
static inline byte mavlink_msg_mount_configure_get_stab_pitch(const mavlink_message_t* msg)
{
 ...
 * @return (1 = yes, 0 = no)
 */
static inline byte mavlink_msg_mount_configure_get_stab_yaw(const mavlink_message_t* msg)
{
