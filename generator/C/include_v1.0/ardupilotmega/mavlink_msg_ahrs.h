...
{
 Single omegaIx; ///< X gyro drift estimate rad/s
 Single omegaIy; ///< Y gyro drift estimate rad/s
 Single omegaIz; ///< Z gyro drift estimate rad/s
 Single accel_weight; ///< average accel_weight
 Single renorm_val; ///< average renormalisation value
 Single error_rp; ///< average error_roll_pitch value
 Single error_yaw; ///< average error_yaw value
} mavlink_ahrs_t;
...
static inline uint16_t mavlink_msg_ahrs_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       Single omegaIx, Single omegaIy, Single omegaIz, Single accel_weight, Single renorm_val, Single error_rp, Single error_yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[28];
	_mav_put_Single(buf, 0, omegaIx);
	_mav_put_Single(buf, 4, omegaIy);
	_mav_put_Single(buf, 8, omegaIz);
	_mav_put_Single(buf, 12, accel_weight);
	_mav_put_Single(buf, 16, renorm_val);
	_mav_put_Single(buf, 20, error_rp);
	_mav_put_Single(buf, 24, error_yaw);
...
static inline void mavlink_msg_ahrs_send(mavlink_channel_t chan, Single omegaIx, Single omegaIy, Single omegaIz, Single accel_weight, Single renorm_val, Single error_rp, Single error_yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[28];
	_mav_put_Single(buf, 0, omegaIx);
 ...
 */
static inline Single mavlink_msg_ahrs_get_omegaIx(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_ahrs_get_omegaIy(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_ahrs_get_omegaIz(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_ahrs_get_accel_weight(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_ahrs_get_renorm_val(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_ahrs_get_error_rp(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_ahrs_get_error_yaw(const mavlink_message_t* msg)
{
