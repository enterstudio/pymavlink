...
typedef struct __mavlink_digicam_control_t
{
 ...
 byte session; ///< 0: stop, 1: start or keep it up //Session control e.g. show/hide lens
 byte zoom_pos; ///< 1 to N //Zoom's absolute position (0 means ignore)
 byte zoom_step; ///< -100 to 100 //Zooming step value to offset zoom from the current position
 byte focus_lock; ///< 0: unlock focus or keep unlocked, 1: lock focus or keep locked, 3: re-lock focus
 byte shot; ///< 0: ignore, 1: shot or start filming
...
static inline uint16_t mavlink_msg_digicam_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       byte target_system, byte target_component, byte session, byte zoom_pos, byte zoom_step, byte focus_lock, byte shot, byte command_id, byte extra_param, Single extra_value)
{
	...
	_mav_put_byte(buf, 6, session);
	_mav_put_byte(buf, 7, zoom_pos);
	_mav_put_byte(buf, 8, zoom_step);
	_mav_put_byte(buf, 9, focus_lock);
	_mav_put_byte(buf, 10, shot);
	_mav_put_byte(buf, 11, command_id);
	_mav_put_byte(buf, 12, extra_param);
...
static inline void mavlink_msg_digicam_control_send(mavlink_channel_t chan, byte target_system, byte target_component, byte session, byte zoom_pos, byte zoom_step, byte focus_lock, byte shot, byte command_id, byte extra_param, Single extra_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[13];
	_mav_put_Single(buf, 0, extra_value);
 ...
 * @return System ID
 */
static inline byte mavlink_msg_digicam_control_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static inline byte mavlink_msg_digicam_control_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_digicam_control_get_session(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_digicam_control_get_zoom_pos(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_digicam_control_get_zoom_step(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_digicam_control_get_focus_lock(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_digicam_control_get_shot(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_digicam_control_get_command_id(const mavlink_message_t* msg)
{
 ...
 */
static inline byte mavlink_msg_digicam_control_get_extra_param(const mavlink_message_t* msg)
{
 ...
 */
static inline Single mavlink_msg_digicam_control_get_extra_value(const mavlink_message_t* msg)
{
