...
typedef struct __mavlink_mount_status_t
{
 ...
 Int32 pointing_a; ///< pitch(deg*100) or lat, depending on mount mode
 Int32 pointing_b; ///< roll(deg*100) or lon depending on mount mode
 Int32 pointing_c; ///< yaw(deg*100) or alt (in cm) depending on mount mode
...
static inline uint16_t mavlink_msg_mount_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       byte target_system, byte target_component, Int32 pointing_a, Int32 pointing_b, Int32 pointing_c)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[14];
	_mav_put_byte(buf, 0, target_system);
	_mav_put_byte(buf, 1, target_component);
	_mav_put_Int32(buf, 2, pointing_a);
	_mav_put_Int32(buf, 6, pointing_b);
	_mav_put_Int32(buf, 10, pointing_c);
...
static inline void mavlink_msg_mount_status_send(mavlink_channel_t chan, byte target_system, byte target_component, Int32 pointing_a, Int32 pointing_b, Int32 pointing_c)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[14];
	_mav_put_byte(buf, 0, target_system);
 ...
 * @return System ID
 */
static inline byte mavlink_msg_mount_status_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static inline byte mavlink_msg_mount_status_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static inline Int32 mavlink_msg_mount_status_get_pointing_a(const mavlink_message_t* msg)
{
 ...
 */
static inline Int32 mavlink_msg_mount_status_get_pointing_b(const mavlink_message_t* msg)
{
 ...
 */
static inline Int32 mavlink_msg_mount_status_get_pointing_c(const mavlink_message_t* msg)
{
