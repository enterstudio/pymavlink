...
typedef struct __mavlink_raw_pressure_t
{
 ...
 Int16 press_abs; ///< Absolute pressure (hectopascal)
 Int16 press_diff1; ///< Differential pressure 1 (hectopascal)
 Int16 press_diff2; ///< Differential pressure 2 (hectopascal)
 Int16 temperature; ///< Raw Temperature measurement 
