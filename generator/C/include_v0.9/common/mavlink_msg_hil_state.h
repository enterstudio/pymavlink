...
static inline void mavlink_msg_hil_state_send(mavlink_channel_t chan, UInt64 usec, Single roll, Single pitch, Single yaw, Single rollspeed, Single pitchspeed, Single yawspeed, Int32 lat, Int32 lon, Int32 alt, Int16 vx, Int16 vy, Int16 vz, Int16 xacc, Int16 yacc, Int16 zacc)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[56];
	_mav_put_UInt64(buf, 0, usec);
 ...
 */
static inline UInt64 mavlink_msg_hil_state_get_usec(const mavlink_message_t* msg)
{
