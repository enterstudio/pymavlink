...
static inline void mavlink_msg_raw_pressure_send(mavlink_channel_t chan, UInt64 usec, Int16 press_abs, Int16 press_diff1, Int16 press_diff2, Int16 temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[16];
	_mav_put_UInt64(buf, 0, usec);
