...
static inline void mavlink_msg_scaled_pressure_send(mavlink_channel_t chan, UInt64 usec, Single press_abs, Single press_diff, Int16 temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[18];
	_mav_put_UInt64(buf, 0, usec);
 ...
 */
static inline UInt64 mavlink_msg_scaled_pressure_get_usec(const mavlink_message_t* msg)
{
