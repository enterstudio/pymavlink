...
static inline uint16_t mavlink_msg_roll_pitch_yaw_thrust_setpoint_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                               mavlink_message_t* msg,
                                   UInt32 public time_boot_ms,Single public roll,Single public pitch,Single public yaw,Single public thrust)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[20];
...
static inline void mavlink_msg_roll_pitch_yaw_thrust_setpoint_send(mavlink_channel_t chan, UInt32 public time_boot_ms, Single public roll, Single public pitch, Single public yaw, Single public thrust)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[20];
	_mav_put_UInt32(buf, 0, time_boot_ms);
 ...
 */
public static UInt32 mavlink_msg_roll_pitch_yaw_thrust_setpoint_get_time_boot_ms(byte[] msg)
{
