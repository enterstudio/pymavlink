 ...
 */
 /*
static uint16 mavlink_msg_hil_controls_pack(byte system_id, byte component_id, ref byte[] msg,
                               UInt64 public time_us, Single public roll_ailerons, Single public pitch_elevator, Single public yaw_rudder, Single public throttle, Single public aux1, Single public aux2, Single public aux3, Single public aux4, byte public mode, byte public nav_mode)
{
...
static inline void mavlink_msg_hil_controls_send(mavlink_channel_t chan, UInt64 public time_us, Single public roll_ailerons, Single public pitch_elevator, Single public yaw_rudder, Single public throttle, Single public aux1, Single public aux2, Single public aux3, Single public aux4, byte public mode, byte public nav_mode)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIL_CONTROLS, buf, 42, 250);
#else
    mavlink_hil_controls_t packet;
	packet.time_us = time_us;
	packet.roll_ailerons = roll_ailerons;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIL_CONTROLS, (const char *)&packet, 42, 250);
#endif
}
