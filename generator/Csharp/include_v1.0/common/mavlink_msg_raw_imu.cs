 ...
 */
 /*
static uint16 mavlink_msg_raw_imu_pack(byte system_id, byte component_id, ref byte[] msg,
...
static inline void mavlink_msg_raw_imu_send(mavlink_channel_t chan, UInt64 public usec, Int16 public xacc, Int16 public yacc, Int16 public zacc, Int16 public xgyro, Int16 public ygyro, Int16 public zgyro, Int16 public xmag, Int16 public ymag, Int16 public zmag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[26];
	_mav_put_UInt64(buf, 0, usec);
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RAW_IMU, buf, 26, 179);
#else
    mavlink_raw_imu_t packet;
	packet.usec = usec;
	packet.xacc = xacc;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RAW_IMU, (const char *)&packet, 26, 179);
#endif
}
 ...
 */
public static UInt64 mavlink_msg_raw_imu_get_usec(byte[] msg)
{
