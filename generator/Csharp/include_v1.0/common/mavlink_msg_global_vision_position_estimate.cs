...
public static UInt16 mavlink_msg_global_vision_position_estimate_pack(byte system_id, byte component_id, byte[] msg,
...
if (MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS) {
    ...
    mavlink_global_vision_position_estimate_t packet = new mavlink_global_vision_position_estimate_t();
	packet.usec = usec;
	packet.x = x;
	packet.y = y;
	packet.z = z;
...
static inline void mavlink_msg_global_vision_position_estimate_send(mavlink_channel_t chan, UInt64 public usec, Single public x, Single public y, Single public z, Single public roll, Single public pitch, Single public yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[32];
	_mav_put_UInt64(buf, 0, usec);
 ...
 */
public static UInt64 mavlink_msg_global_vision_position_estimate_get_usec(byte[] msg)
{
 ...
 */
public static Single mavlink_msg_global_vision_position_estimate_get_x(byte[] msg)
{
 ...
 */
public static Single mavlink_msg_global_vision_position_estimate_get_y(byte[] msg)
{
 ...
 */
public static Single mavlink_msg_global_vision_position_estimate_get_z(byte[] msg)
{
 ...
 */
public static Single mavlink_msg_global_vision_position_estimate_get_roll(byte[] msg)
{
 ...
 */
public static Single mavlink_msg_global_vision_position_estimate_get_pitch(byte[] msg)
{
 ...
 */
public static Single mavlink_msg_global_vision_position_estimate_get_yaw(byte[] msg)
{
 ...
 */
public static void mavlink_msg_global_vision_position_estimate_decode(byte[] msg, ref mavlink_global_vision_position_estimate_t global_vision_position_estimate)
{
    if (MAVLINK_NEED_BYTE_SWAP) {
        ...
        int len = 32; //Marshal.SizeOf(global_vision_position_estimate);
        IntPtr i = Marshal.AllocHGlobal(len);
        Marshal.Copy(msg, 0, i, len);
        global_vision_position_estimate = (mavlink_global_vision_position_estimate_t)Marshal.PtrToStructure(i, ((object)global_vision_position_estimate).GetType());
