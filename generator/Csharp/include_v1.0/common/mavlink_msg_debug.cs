...
static inline void mavlink_msg_debug_send(mavlink_channel_t chan, byte public ind, Single public value)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DEBUG, buf, 5, 127);
#else
    mavlink_debug_t packet;
	packet.value = value;
	packet.ind = ind;

    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DEBUG, (const char *)&packet, 5, 127);
#endif
}
