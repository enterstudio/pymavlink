...
static uint16 mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_pack(byte system_id, byte component_id, ref byte[] msg,
                               UInt32 public time_ms, Single public roll_speed, Single public pitch_speed, Single public yaw_speed, Single public thrust)
{
...
static inline void mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_send(mavlink_channel_t chan, UInt32 public time_ms, Single public roll_speed, Single public pitch_speed, Single public yaw_speed, Single public thrust)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[20];
	_mav_put_UInt32(buf, 0, time_ms);
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROLL_PITCH_YAW_SPEED_THRUST_SETPOINT, buf, 20, 148);
#else
    mavlink_roll_pitch_yaw_speed_thrust_setpoint_t packet;
	packet.time_ms = time_ms;
	packet.roll_speed = roll_speed;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROLL_PITCH_YAW_SPEED_THRUST_SETPOINT, (const char *)&packet, 20, 148);
#endif
}
 ...
 */
public static UInt32 mavlink_msg_roll_pitch_yaw_speed_thrust_setpoint_get_time_ms(byte[] msg)
{
