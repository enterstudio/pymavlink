...
static inline void mavlink_msg_statustext_send(mavlink_channel_t chan, byte public severity, const string [MarshalAs(UnmanagedType.ByValArray,SizeConst=50)]
 publictext)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[51];
 ...
 */
public static string mavlink_msg_statustext_get_text(byte[] msg)
{
    return System.Text.ASCIIEncoding.ASCII.GetString(msg,1,50); //(msg, 50,  1);
}
