 ...
 */
 /*
static uint16 mavlink_msg_scaled_imu_pack(byte system_id, byte component_id, ref byte[] msg,
...
static inline void mavlink_msg_scaled_imu_send(mavlink_channel_t chan, UInt64 public usec, Int16 public xacc, Int16 public yacc, Int16 public zacc, Int16 public xgyro, Int16 public ygyro, Int16 public zgyro, Int16 public xmag, Int16 public ymag, Int16 public zmag)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SCALED_IMU, buf, 26, 222);
#else
    mavlink_scaled_imu_t packet;
	packet.usec = usec;
	packet.xacc = xacc;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SCALED_IMU, (const char *)&packet, 26, 222);
#endif
}
