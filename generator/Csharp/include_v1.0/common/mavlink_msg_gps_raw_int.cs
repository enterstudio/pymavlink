...
static uint16 mavlink_msg_gps_raw_int_pack(byte system_id, byte component_id, ref byte[] msg,
                               UInt64 public usec, byte public fix_type, Int32 public lat, Int32 public lon, Int32 public alt, UInt16 public eph, UInt16 public epv, UInt16 public vel, UInt16 public hdg, byte public satellites_visible)
{
...
static inline void mavlink_msg_gps_raw_int_send(mavlink_channel_t chan, UInt64 public usec, byte public fix_type, Int32 public lat, Int32 public lon, Int32 public alt, UInt16 public eph, UInt16 public epv, UInt16 public vel, UInt16 public hdg, byte public satellites_visible)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[30];
	_mav_put_UInt64(buf, 0, usec);
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_RAW_INT, buf, 30, 185);
#else
    mavlink_gps_raw_int_t packet;
	packet.usec = usec;
	packet.lat = lat;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_RAW_INT, (const char *)&packet, 30, 185);
#endif
}
 ...
 */
public static UInt16 mavlink_msg_gps_raw_int_get_hdg(byte[] msg)
{
