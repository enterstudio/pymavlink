...
public static UInt16 mavlink_msg_vision_position_estimate_pack(byte system_id, byte component_id, byte[] msg,
...
if (MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS) {
    ...
    mavlink_vision_position_estimate_t packet = new mavlink_vision_position_estimate_t();
	packet.usec = usec;
	packet.x = x;
	packet.y = y;
	packet.z = z;
