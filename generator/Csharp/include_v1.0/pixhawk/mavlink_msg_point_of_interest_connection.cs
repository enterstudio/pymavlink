...
if (MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS) {
	Array.Copy(BitConverter.GetBytes(xp1),0,msg,0,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(yp1),0,msg,4,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(zp1),0,msg,8,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(xp2),0,msg,12,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(yp2),0,msg,16,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(zp2),0,msg,20,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(timeout),0,msg,24,sizeof(UInt16));
