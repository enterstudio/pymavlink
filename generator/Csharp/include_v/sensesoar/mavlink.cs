...
namespace ArdupilotMega
{
    ...
    {
        public const string MAVLINK_BUILD_DATE = "Thu Jul 26 18:28:27 2012";
        public const string MAVLINK_WIRE_PROTOCOL_VERSION = "1.0";
        public const int MAVLINK_MAX_DIALECT_PAYLOAD_SIZE = 32;
    ...
    public const byte MAVLINK_MSG_ID_OBS_POSITION = 170;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=12)]
    public struct mavlink_obs_position_t
    {
        /// <summary> Longitude expressed in 1E7 </summary>
        public  Int32 lon;
            /// <summary> Latitude expressed in 1E7 </summary>
        public  Int32 lat;
            /// <summary> Altitude expressed in milimeters </summary>
        public  Int32 alt;
    
    };


    public const byte MAVLINK_MSG_ID_OBS_VELOCITY = 172;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=12)]
    public struct mavlink_obs_velocity_t
    {
    ...
    public const byte MAVLINK_MSG_ID_OBS_ATTITUDE = 174;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=32)]
    public struct mavlink_obs_attitude_t
    {
        /// <summary> Quaternion re;im </summary>
    ...
    public const byte MAVLINK_MSG_ID_OBS_WIND = 176;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=12)]
    public struct mavlink_obs_wind_t
    {
    ...
    public const byte MAVLINK_MSG_ID_OBS_AIR_VELOCITY = 178;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=12)]
    public struct mavlink_obs_air_velocity_t
    {
        /// <summary> Air speed </summary>
        public  Single magnitude;
            /// <summary> angle of attack </summary>
        public  Single aoa;
            /// <summary> slip angle </summary>
        public  Single slip;
    
    };


    public const byte MAVLINK_MSG_ID_OBS_BIAS = 180;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=24)]
    public struct mavlink_obs_bias_t
    {
        /// <summary> accelerometer bias </summary>
        [MarshalAs(UnmanagedType.ByValArray,SizeConst=3)]
		public float accBias;
            /// <summary> gyroscope bias </summary>
        [MarshalAs(UnmanagedType.ByValArray,SizeConst=3)]
    ...
    public const byte MAVLINK_MSG_ID_OBS_QFF = 182;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=4)]
    public struct mavlink_obs_qff_t
    {
        /// <summary> Wind </summary>
        public  Single qff;
    ...
    public const byte MAVLINK_MSG_ID_OBS_AIR_TEMP = 183;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=4)]
    public struct mavlink_obs_air_temp_t
    {
        /// <summary> Air Temperatur </summary>
        public  Single airT;
    
    };


    public const byte MAVLINK_MSG_ID_FILT_ROT_VEL = 184;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=12)]
    public struct mavlink_filt_rot_vel_t
    {
        /// <summary> rotational velocity </summary>
        [MarshalAs(UnmanagedType.ByValArray,SizeConst=3)]
		public float rotVel;
    ...
    public const byte MAVLINK_MSG_ID_LLC_OUT = 186;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=12)]
    public struct mavlink_llc_out_t
    {
        /// <summary> Servo signal </summary>
        [MarshalAs(UnmanagedType.ByValArray,SizeConst=4)]
		public int16_t servoOut;
            /// <summary> motor signal </summary>
        [MarshalAs(UnmanagedType.ByValArray,SizeConst=2)]
		public int16_t MotorOut;
    
    };


    public const byte MAVLINK_MSG_ID_PM_ELEC = 188;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=20)]
    public struct mavlink_pm_elec_t
    {
        /// <summary> current power consumption </summary>
        public  Single PwCons;
            /// <summary> battery status </summary>
        public  Single BatStat;
            /// <summary> Power generation from each module </summary>
        [MarshalAs(UnmanagedType.ByValArray,SizeConst=3)]
		public float PwGen;
    ...
    public const byte MAVLINK_MSG_ID_SYS_Stat = 190;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=4)]
    public struct mavlink_sys_stat_t
    {
        /// <summary> gps status </summary>
        public  byte gps;
            /// <summary> actuator status </summary>
        public  byte act;
            /// <summary> module status </summary>
        public  byte mod;
            /// <summary> module status </summary>
        public  byte commRssi;
    
    };


    public const byte MAVLINK_MSG_ID_CMD_AIRSPEED_CHNG = 192;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=5)]
    public struct mavlink_cmd_airspeed_chng_t
    {
    ...
    public const byte MAVLINK_MSG_ID_CMD_AIRSPEED_ACK = 194;
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=5)]
    public struct mavlink_cmd_airspeed_ack_t
    {
        /// <summary> commanded airspeed </summary>
        public  Single spCmd;
            /// <summary> 0:ack, 1:nack </summary>
        public  byte ack;
