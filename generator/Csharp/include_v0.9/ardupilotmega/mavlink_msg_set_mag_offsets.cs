...
if (MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS) {
	...
	Array.Copy(BitConverter.GetBytes(mag_ofs_x),0,msg,2,sizeof(Int16));
	Array.Copy(BitConverter.GetBytes(mag_ofs_y),0,msg,4,sizeof(Int16));
	Array.Copy(BitConverter.GetBytes(mag_ofs_z),0,msg,6,sizeof(Int16));
