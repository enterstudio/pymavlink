...
if (MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS) {
	...
	Array.Copy(BitConverter.GetBytes(chan1_raw),0,msg,2,sizeof(UInt16));
	Array.Copy(BitConverter.GetBytes(chan2_raw),0,msg,4,sizeof(UInt16));
	Array.Copy(BitConverter.GetBytes(chan3_raw),0,msg,6,sizeof(UInt16));
	Array.Copy(BitConverter.GetBytes(chan4_raw),0,msg,8,sizeof(UInt16));
	Array.Copy(BitConverter.GetBytes(chan5_raw),0,msg,10,sizeof(UInt16));
	Array.Copy(BitConverter.GetBytes(chan6_raw),0,msg,12,sizeof(UInt16));
	Array.Copy(BitConverter.GetBytes(chan7_raw),0,msg,14,sizeof(UInt16));
	Array.Copy(BitConverter.GetBytes(chan8_raw),0,msg,16,sizeof(UInt16));
