...
if (MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS) {
	...
	Array.Copy(BitConverter.GetBytes(roll_speed),0,msg,2,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(pitch_speed),0,msg,6,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(yaw_speed),0,msg,10,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(thrust),0,msg,14,sizeof(Single));
