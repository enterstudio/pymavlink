...
if (MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS) {
	...
	Array.Copy(BitConverter.GetBytes(heading),0,msg,8,sizeof(Int16));
	Array.Copy(BitConverter.GetBytes(throttle),0,msg,10,sizeof(UInt16));
	Array.Copy(BitConverter.GetBytes(alt),0,msg,12,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(climb),0,msg,16,sizeof(Single));
