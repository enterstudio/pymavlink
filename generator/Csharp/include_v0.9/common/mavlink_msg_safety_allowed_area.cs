...
if (MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS) {
	Array.Copy(BitConverter.GetBytes(frame),0,msg,0,sizeof(byte));
	Array.Copy(BitConverter.GetBytes(p1x),0,msg,1,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(p1y),0,msg,5,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(p1z),0,msg,9,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(p2x),0,msg,13,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(p2y),0,msg,17,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(p2z),0,msg,21,sizeof(Single));
