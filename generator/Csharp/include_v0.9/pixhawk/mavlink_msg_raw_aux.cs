...
if (MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS) {
	...
	Array.Copy(BitConverter.GetBytes(vbat),0,msg,8,sizeof(UInt16));
	Array.Copy(BitConverter.GetBytes(temp),0,msg,10,sizeof(Int16));
	Array.Copy(BitConverter.GetBytes(baro),0,msg,12,sizeof(Int32));
