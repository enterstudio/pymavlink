...
if (MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS) {
	...
	Array.Copy(BitConverter.GetBytes(roll),0,msg,14,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(pitch),0,msg,18,sizeof(Single));
	Array.Copy(BitConverter.GetBytes(yaw),0,msg,22,sizeof(Single));
